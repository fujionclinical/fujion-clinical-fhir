...
public class ObservationComponentTransform extends AbstractModelTransform<IObservationComponent, ObservationComponentComponent> {
    ...
    public ObservationComponentComponent _fromLogicalModel(IObservationComponent src) {
        ...
        dest.setDataAbsentReason(FhirUtilStu3.convertEnumToCodeableConcept(src.getDataAbsentReason(), "http://hl7.org/fhir/data-absent-reason"));
        Object value = src.getValue();

        if (value != null) {
            IModelTransform transform = ModelTransforms.getInstance().get(value.getClass(), Type.class);
    ...
    public IObservationComponent _toLogicalModel(ObservationComponentComponent src) {
        ...
        dest.setDataAbsentReason(FhirUtilStu3.convertCodeableConceptToEnum(src.getDataAbsentReason(), IObservationComponent.DataAbsentReason.class));
