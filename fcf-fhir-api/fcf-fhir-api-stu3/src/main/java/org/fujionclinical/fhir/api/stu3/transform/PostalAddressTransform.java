...
public class PostalAddressTransform extends AbstractDatatypeTransform<Address, org.hl7.fhir.dstu3.model.Address> {
    ...
    private PostalAddressTransform() {
        super(Address.class, org.hl7.fhir.dstu3.model.Address.class);
    }

    @Override
    public org.hl7.fhir.dstu3.model.Address _fromLogicalModel(Address src) {
        org.hl7.fhir.dstu3.model.Address dest = new org.hl7.fhir.dstu3.model.Address();
        dest.setPeriod(PeriodTransform.getInstance().fromLogicalModel(src.getPeriod()));
        dest.setUse(CoreUtil.enumToEnum(src.getUse(), org.hl7.fhir.dstu3.model.Address.AddressUse.class));
        dest.setType(CoreUtil.enumToEnum(src.getType(), org.hl7.fhir.dstu3.model.Address.AddressType.class));
    ...
    @Override
    public Address _toLogicalModel(org.hl7.fhir.dstu3.model.Address src) {
