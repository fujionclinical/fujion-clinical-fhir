...
public class PatientWrapper extends BaseResourceWrapper<Patient> implements IPatient {
    ...
    protected PatientWrapper(Patient patient) {
        ...
        mrn = IdentifierTransform.getInstance().wrap(FhirUtilStu3.getMRN(patient));
    ...
    public MaritalStatus getMaritalStatus() {
        return FhirUtilStu3.convertMaritalStatus(getWrapped().getMaritalStatus());
    }

    @Override
    public void setMaritalStatus(MaritalStatus maritalStatus) {
        getWrapped().setMaritalStatus(FhirUtilStu3.convertMaritalStatus(maritalStatus));
    }
    ...
    public DateTimeWrapper getDeceasedDate() {
        return FhirUtilStu3.convertDate(getWrapped().getDeceased());
    }

    @Override
    public void setDeceasedDate(DateTimeWrapper date) {
        getWrapped().setDeceased(FhirUtilStu3.convertDateToType(date));
    }
