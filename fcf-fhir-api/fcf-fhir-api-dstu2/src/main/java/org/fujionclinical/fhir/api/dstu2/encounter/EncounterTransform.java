...
import org.fujionclinical.fhir.api.dstu2.transform.PeriodTransform;
import org.fujionclinical.fhir.api.dstu2.transform.ReferenceTransform;
...
public class EncounterTransform extends BaseResourceTransform<IEncounter, Encounter> {
    ...
    @Override
    protected List<IdentifierDt> getIdentifiers(Encounter encounter) {
