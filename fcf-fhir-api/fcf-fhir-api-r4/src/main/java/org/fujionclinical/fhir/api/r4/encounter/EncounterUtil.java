...
public class EncounterUtil {
    ...
    private static synchronized void loadServiceCategories() {
        if (serviceCategories == null) {
            ...
            for (CodeSystem cs : FhirUtilR4.getEntries(bundle, CodeSystem.class)) {
    ...
    public static String getServiceCategory(Encounter encounter) {
        CodeableConcept cpt = encounter == null ? null : FhirUtilR4.getFirst(encounter.getType());
        Coding coding = cpt == null ? null : FhirUtilR4.getFirst(cpt.getCoding());
    ...
    public static HumanName getName(EncounterParticipantComponent participant) {
        ...
        List<HumanName> names = FhirUtilR4.getNames(resource);
        return names == null ? null : FhirUtilR4.getName(names);
    }
    ...
    public static EncounterLocationComponent getLocationByPhysicalType(
        ...
        for (EncounterLocationComponent encounterLocation : encounter.getLocation()) {
            ...
            if (physicalType.equals(FhirUtilR4.getFirst(location.getPhysicalType().getCoding()).getCode())) {
