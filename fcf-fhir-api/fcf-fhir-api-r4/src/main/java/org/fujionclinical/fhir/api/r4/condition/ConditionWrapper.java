...
public class ConditionWrapper extends BaseResourceWrapper<Condition> implements ICondition {
    ...
    public void setClinicalStatus(ClinicalStatus clinicalStatus) {
        CodeableConcept code = FhirUtilR4.createCodeableConcept(CONDITION_CLINICAL_STATUS_SYSTEM, clinicalStatus.name().toLowerCase(), clinicalStatus.toString());
    ...
    public void setVerificationStatus(VerificationStatus verificationStatus) {
        CodeableConcept code = FhirUtilR4.createCodeableConcept(CONDITION_VERIFICATION_STATUS_SYSTEM, verificationStatus.name().toLowerCase(), verificationStatus.toString());
