 ...
 * #L%
 */
package org.fujionclinical.fhir.api.r4.medication;
...
public class MedicationService {
    ...
    public MedicationService(R4DataSource dataSource) {
    ...
    public List<MedicationAdministration> searchMedAdminByIdentifier(
            String system,
            String code) {
        Identifier identifier = R4Utils.createIdentifier(system, code);
