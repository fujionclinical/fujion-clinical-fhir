...
import org.fujionclinical.fhir.lib.sharedforms.common.Constants;
import org.fujionclinical.fhir.api.r5.common.BaseService;
import org.fujionclinical.fhir.api.r5.common.FhirUtil;
import org.fujionclinical.fhir.api.r5.common.NarrativeService;
import org.fujionclinical.fhir.api.r5.patient.PatientContext;
import org.fujionclinical.fhir.subscription.r5.ISubscriptionCallback;
import org.fujionclinical.fhir.subscription.r5.ResourceSubscriptionManager;
import org.fujionclinical.fhir.subscription.r5.SubscriptionWrapper;
    ...
    protected void showDetail(BaseComponent item) {
        ...
        if (!StringUtils.isEmpty(detail)) {
            if (getShowDetailPane()) {
                ...
                try {
                    Window window = (Window) PageUtil.createPage(Constants.RESOURCE_PREFIX + "resourceListDetailPopup.fsp", null, map).get(0);
                    window.modal(null);
                } catch (Exception e) {
