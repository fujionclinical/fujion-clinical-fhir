...
public class PatientListController extends FrameworkController {
    ...
    public PatientListController(IPatientAdapterFactory patientAdapterFactory) {
    ...
    public void afterInitialized(BaseComponent comp) {
        ...
        rows.setRenderer(new PatientListItemRenderer(patientList, patientAdapterFactory));
