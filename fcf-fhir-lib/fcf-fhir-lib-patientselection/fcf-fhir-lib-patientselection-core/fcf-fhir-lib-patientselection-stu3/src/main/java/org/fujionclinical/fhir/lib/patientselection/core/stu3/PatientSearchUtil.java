 ...
 * #L%
 */
package org.fujionclinical.fhir.lib.patientselection.core.stu3;
...
import org.fujionclinical.fhir.stu3.api.patient.PatientSearchCriteria;
import org.fujionclinical.fhir.stu3.api.patient.PatientUtil;
...
public class PatientSearchUtil {
    ...
    private static final Comparator<Patient> patientComparator = new Comparator<Patient>() {
        ...
        public int compare(Patient patient1, Patient patient2) {
            HumanName name1 = FhirUtil.getName(patient1.getName());
            HumanName name2 = FhirUtil.getName(patient2.getName());
