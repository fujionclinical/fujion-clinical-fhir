 ...
 * #L%
 */
package org.fujionclinical.fhir.common.security.oauth;

import org.apache.commons.lang3.Validate;
import org.fujionclinical.fhir.common.security.ICredentialProvider;
...
public class ClientCredentialsAccessTokenRequest<T extends ICredentialProvider> extends AbstractAccessTokenRequest<T>
    ...
    public ClientCredentialsAccessTokenRequest(String clientId, T clientCredentials, Scopes scopes) {
        ...
        if (clientCredentials instanceof JWTCredentials) {
            ...
            Validate.notNull(((JWTCredentials) clientCredentials).getAudience(),
                    "Authorization server's token URL must not ne null");
            ...
            this.tokenRequestParams
                    .put("client_assertion", ((JWTCredentials) clientCredentials).getCredentials().serialize());
        }
