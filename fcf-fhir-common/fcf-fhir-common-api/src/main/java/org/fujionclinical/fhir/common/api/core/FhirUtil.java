 ...
 * #L%
 */
package org.fujionclinical.fhir.common.api.core;
...
public class FhirUtil {
     ...
     */
    public static <T extends IBaseResource> boolean classMatches(List<Class<T>> classes, IBaseResource resource) {
    ...
    public static <T> T getProperty(IBaseResource resource, String getter, Class<T> expectedClass) {
        Object result = null;
