...
public class ResourceSubscriptionService {
    ...
    public static final String SUBSCRIPTION_CHANNEL_TYPE_SYSTEM = "http://terminology.hl7.org/CodeSystem/subscription-channel-type";
    ...
    private final CodeableConcept subscriptionChannelType = new CodeableConcept();
    ...
    public ResourceSubscriptionService(
        ...
        Coding channelType = new Coding(SUBSCRIPTION_CHANNEL_TYPE_SYSTEM, "rest-hook", "Rest Hook");
        subscriptionChannelType.addCoding(channelType);
        destroy();
     ...
     * @return The subscription wrapper.
     */
    public synchronized SubscriptionWrapper subscribe(
            String criteria,
     ...
     */
    private SubscriptionWrapper getOrCreateSubscription(
            String criteria,
            PayloadType payloadType) {
