 ...
 */
public class FhirUtil extends org.fujionclinical.fhir.common.api.core.FhirUtil {
    ...
    public static String getDisplayValue(CodeableConceptDt value) {
        CodingDt coding = org.fujionclinical.fhir.dstu2.api.common.FhirUtil.getFirst(value.getCoding());
    ...
    public static String getDisplayValue(QuantityDt value) {
        String val = value.getValue() != null ? value.getValue().toString() : "";
    ...
    public static String getDisplayValue(ResourceReferenceDt value) {
        return value.getDisplay().getValueNotNull();
    }
    ...
    public static String getDisplayValue(TimingDt value) {
        ...
        TimingDt.Repeat repeat = value.getRepeat();
