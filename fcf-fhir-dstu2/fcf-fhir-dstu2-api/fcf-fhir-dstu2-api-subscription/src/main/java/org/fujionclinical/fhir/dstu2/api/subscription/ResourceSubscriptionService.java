 ...
 * #L%
 */
package org.fujionclinical.fhir.dstu2.api.subscription;
...
public class ResourceSubscriptionService {
    ...
    private final CodingDt subscriptionTag;
    ...
    public void destroy() {
        if (!disabled) {
            try {
                ICriterion<?> criterion = Subscription.TAG.exactly().systemAndCode(subscriptionTag.getSystem(),
