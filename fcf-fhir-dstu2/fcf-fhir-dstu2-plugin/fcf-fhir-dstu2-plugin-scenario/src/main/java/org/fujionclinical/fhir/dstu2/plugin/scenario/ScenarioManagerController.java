 ...
 * #L%
 */
package org.fujionclinical.fhir.dstu2.plugin.scenario;
...
import org.fujionclinical.fhir.dstu2.api.scenario.Scenario;
import org.fujionclinical.fhir.dstu2.api.scenario.ScenarioContext;
import org.fujionclinical.fhir.dstu2.api.scenario.ScenarioContext.IScenarioContextEvent;
import org.fujionclinical.fhir.dstu2.api.scenario.ScenarioRegistry;
...
public class ScenarioManagerController extends PluginController implements IScenarioContextEvent {
    ...
    public static void show() {
        DialogUtil.popup("web/org/fujionclinical/fhir/dstu2/plugin/scenario/scenarioManagerWin.fsp", true, true, true);
    }
