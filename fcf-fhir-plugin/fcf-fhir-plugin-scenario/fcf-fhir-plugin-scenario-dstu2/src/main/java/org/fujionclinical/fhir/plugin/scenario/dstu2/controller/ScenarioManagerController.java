 ...
 * #L%
 */
package org.fujionclinical.fhir.plugin.scenario.dstu2.controller;
...
import org.fujionclinical.fhir.plugin.scenario.dstu2.api.Scenario;
import org.fujionclinical.fhir.plugin.scenario.dstu2.api.ScenarioContext;
import org.fujionclinical.fhir.plugin.scenario.dstu2.api.ScenarioContext.IScenarioContextEvent;
import org.fujionclinical.fhir.plugin.scenario.dstu2.api.ScenarioRegistry;
...
public class ScenarioManagerController extends PluginController implements IScenarioContextEvent {
    ...
    public static void show() {
        DialogUtil.popup("web/org/fujionclinical/fhir/plugin/scenario/dstu2/scenarioManagerWin.fsp", true, true, true);
    }
